...
if (isset($_POST["submit"])) {
  ...
  $createdbyuserid = $_SESSION["user_id"];
   ...
   $sql = "INSERT INTO service_requests (id, role, skilllevel, location, skillset, duration, projectname,taskdescription,weight) VALUES ('1001', 'fgu', '2', 'fytfy','ghg','hh','yg','guh','hjh')";    
    ...
    $check = mysqli_query($conn, "SELECT id FROM service_requests WHERE id == '1001' ");
}
...
if (isset($_POST["save"])) {
    ...
    $sql = "INSERT INTO service_requests (role, skilllevel, location, skillset, duration, projectname,taskdescription,weight,comments,Created_by_userid,created_at,is_open_for_bidding,cycle,Submission_status) VALUES ('$role', '$skilllevel', '$location','$skillset','$duration','$projectname','$taskdescription','$weight','$comments','$createdbyuserid',current_timestamp,'1','1','0')";
    $result = mysqli_query($conn, $sql);
            ...
            <div class="form-inputs">
                ...
                <div class="form-input-actions">
                    <div id="actionButtons">
                        <button class="btn btn-secondary js-reset-service-form">Submit</button>
                ...
                <div>
                    <div class="form-input-actions">
                        <div id="actionButtons">
                            <button class="btn btn-secondary js-reset-service-form">Save</button>
                    ...
                    <!--<div>
                        <div class="form-input-actions">
                            <div id="actionButtons">
                                <button class="btn btn-secondary js-reset-service-form"   onclick="resetInputFields()">Save</button>
                            </div>
                        </div>
                    </div>-->
        </form>
